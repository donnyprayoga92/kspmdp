...
Nama VA    : KSP MDP
*_dimohon untuk menyampaikan bukti transfer setelah melakukan pembayaran melalui VA_*
...
WHERE j.nama = 'SIMPANAN WAJIB' AND u.aktif = '1' AND a.biayaandroid = '0' AND t.saldo < '51000'
  AND t.id = (
      SELECT t2.id 
