...
if (isset($_POST['tambah'])) {
    ...
    mysqli_query($conn, "INSERT INTO pendidikan (id, nama, user, jam) VALUES ('$id','$nama','$usr','$jam')");
...
if (isset($_POST['update'])) {
    ...
    mysqli_query($conn, "UPDATE pendidikan SET nama='$nama', user='$usr' WHERE id='$id'");
    echo "<script>window.location.href='pendidikan.php';</script>";
    exit;
}
...
if (isset($_GET['edit'])) {
    $id = $_GET['edit'];
    $result = mysqli_query($conn, "SELECT * FROM pendidikan WHERE id='$id'");
...
<div class="container py-4">
    ...
    <div class="card mb-4 shadow-sm">
        <div class="card-header">
            <?= $edit ? 'Edit Data pendidikan' : 'Tambah Data pendidikan'; ?>
        </div>
        <div class="card-body">
